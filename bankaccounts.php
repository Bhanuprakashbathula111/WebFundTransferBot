   ...
   <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="bankaccounts.php" style="margin-top: 30px;font-size: 20px;color: #0c4ad4">Bank Accounts</a></li>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped">
                           ...
                           include 'config.php';
                                ...
                                $sql = "SELECT * FROM bank where email='$email'";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                  ...
                                  while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<tr><td> " . $row["bid"]. " </td><td> " . $row["name"]. " </td><td> " . $row["acno"]. " </td> <td> " . $row["ifsc"]. " </td><td> " . $row["balance"]. "</td>
